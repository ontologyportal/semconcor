...
%>
<%@ page import="com.articulate.nlp.*,com.articulate.nlp.corpora.*,com.articulate.nlp.pipeline.*,com.articulate.nlp.semRewrite.*,com.articulate.semconcor.*" %>
        ...
        for (int i = 0; i < dependencies.size(); i++) {
            ...
            if (!printed.contains(s)) {
                ...
                if (depGraph != null && depGraph.equals("checked")) {
                    ...
                    out.println("var docData=" + bratAnnotationUtil.getBratAnnotations(dependencies) + ";</script>");
